function [best_mpc,all_scatter_objects,all_marker_objects] = create_an_overlay_plot_updated_2(fig_handle,xVsY,labels,xAxis,yAxis,feature,experiment,folder_where_cluster_tables_should_be_saved,called_by,folder_where_figures_should_be_saved)
%% format underscores
