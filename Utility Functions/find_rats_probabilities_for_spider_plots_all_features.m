function [table_of_probabilities,list_of_clusters] = find_rats_probabilities_for_spider_plots_all_features(location_of_cluster_tables,experiment,excludeOrDont,exclude_features_or_dont,features_to_exclude)
