function [euc_distances] = find_euc_dist_for_all_features(location_of_cluster_tables,experiment,excludeOrDont,exclude_features_or_dont,features_to_exclude)
    ...
    function [euc_dist_array] = get_euclidian_distances(table_of_probabilities)
        ...
        for i=1:size(all_probabilities,1)
            ...
            for j=i+1:size(all_probabilities,1)
                ...
                euc_dist_array = [euc_dist_array,euc_distance];
            end
        end
...
euc_distances = get_euclidian_distances(table_of_probabilities);
% disp(table_of_probabilities);
