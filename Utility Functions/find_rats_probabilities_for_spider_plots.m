function [table_of_probabilities] = find_rats_probabilities_for_spider_plots(location_of_cluster_tables,experiment,excludeOrDont,onlyDoSingleVariable,singleVariable)
