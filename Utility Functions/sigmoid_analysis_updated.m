function sigmoid_analysis_updated(table_of_psychometric_functions,feature)
    function[] = createSigmoidFigures(results,feature)
        %         feature = strrep(feature,"_","\_");
        for i = 1:height(results)
            ...
            if strcmp(feature,'travel_pixel')
                if gof3.rsquare >= .4
                    plot(fitobject3,x.',y.');
            ...
            if strcmp(feature,'stopping_points')
                if gof3.rsquare >= .4
                    plot(fitobject3,x.',y.');
                    ylabel(strrep(feature,"_","\_"))
                    xlabel("Reward")
            ...
            if strcmp(feature,'rotation_points')
                if gof3.rsquare >= .4
                    plot(fitobject3,x.',y.');
                    ylabel(strrep(feature,"_","\_"))
                    xlabel("Reward")
            ...
            if strcmp(feature,'reaction_time')
                if gof3.rsquare >= .4
                    plot(fitobject3,x.',y.');
                    ylabel(strrep(feature,"_","\_"))
                    xlabel("Reward")
            ...
            if strcmp(feature,'reward_choice')
                if gof3.rsquare >= .6
                    plot(fitobject3,x.',y.');
                    ylabel(strrep(feature,"_","\_"))
                    xlabel("Reward")
    ...
    function [] = create_sigmoid_figures_updated(results,feature)
        for i = 1:height(results)
            disp(strcat(feature, " ",string(i),"/",string(height(results))))
    ...
    function create_directories_updated(feature)
        mkdir(strcat(feature," 2 Parameter Sigmoid"))
        mkdir(strcat(feature," 3 Parameter Sigmoid"))
        mkdir(strcat(feature," 4 Parameter Sigmoid"))
        mkdir(strcat(feature," Sigmoid Data"))
        mkdir(strcat(feature," Lines"))
        mkdir(strcat(feature," Line Data"))
        mkdir(strcat(feature," Parabolas"))
        mkdir(strcat(feature," Parabola Data"))

    end

% create_directories()
create_directories_updated(feature)

% createSigmoidFigures(table_of_psychometric_functions,feature)
create_sigmoid_figures_updated(table_of_psychometric_functions,feature);
