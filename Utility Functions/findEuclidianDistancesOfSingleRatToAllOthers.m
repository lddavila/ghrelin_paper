function [table_of_rat_to_euc_distance_array] = findEuclidianDistancesOfSingleRatToAllOthers(location_of_cluster_tables,experiment,excludeOrDont,onlyDoSingleVariable,singleVariable)
    ...
    function [map_of_rat_to_euc_dist_array] = get_euclidian_distances(table_of_probabilities)
        all_probabilities = [];
...
map_of_rat_to_euc_distance_array = get_euclidian_distances(table_of_probabilities);
% disp(all_euclidian_distances)
table_of_rat_to_euc_distance_array = table(keys(map_of_rat_to_euc_distance_array).',values(map_of_rat_to_euc_distance_array).','VariableNames',{'subject_id','euc_dist_array'});
